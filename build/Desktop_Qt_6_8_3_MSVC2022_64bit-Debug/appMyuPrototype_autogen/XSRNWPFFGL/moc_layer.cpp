...
static constexpr auto qt_meta_stringdata_ZN5LayerE = QtMocHelpers::stringData(
    "Layer"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5LayerE[] = {
...
Q_CONSTINIT const QMetaObject Layer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5LayerE.offsetsAndSizes,
    qt_meta_data_ZN5LayerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5LayerE_t,
        // Q_OBJECT / Q_GADGET
...
void *Layer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5LayerE.stringdata0))
